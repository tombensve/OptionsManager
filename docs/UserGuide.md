<img src="images/OptionsManager-logo-small.png"/>

# Options Manager 2.0

#### Copyright © 2009, 2012 Natusoft AB
...
## Introduction
  ...
  *se.biltmore….* to *se.natusoft….* The package change was required due to a
  ...
  used from the beginning looking in the hind mirror :-). 
...
The markdown CSS for the generated html document is based on Florian Wolters markdown.css. 
