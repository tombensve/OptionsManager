...
/**
 * This is thrown by OptionManager when it has identified incorrect code in options model.
 */
@Project(
    name="OptionsManager",
...
public class OptionsModelException extends OptionsException {

    /**
     * Creates a new OptionsModelException instance.
     * 
     * @param message The exception message.
     */
    public OptionsModelException(String message) {
        super(message);
    }
     ...
     */
    public OptionsModelException(String message, Throwable cause) {
        super(message, cause);
    }
}
